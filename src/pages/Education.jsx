...
const ITEMS = [
  { year: '2024 — Now', school: 'Gogte Institute of Technology', detail: 'B.E. Computer Science & Engineering — Belagavi, Karnataka. First year. Already winning competitions and leading two clubs.', now: true },
  { year: '2023 — 2024', school: 'Allen Institute, Bangalore', detail: 'Gap year preparing for NEET. Decided engineering was the right path — and it turned out to be exactly that.' },
  { year: '2021 — 2023', school: 'RLS PU College of Science', detail: '11th & 12th standard, Science stream. Back in India after years in the UAE — adapting fast, performing well.' },
