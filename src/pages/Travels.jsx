  ...
  return (
    <main className={styles.main}>
      <div className="page-hero">
        ...
        <p className="page-sub">Born in India. Grew up in Sharjah. The world has always been the classroom.</p>
      </div>
      ...
      <div className={styles.listSection}>
        {PLACES.map((p, i) => {
          const ref = useReveal()import { useReveal } from '../components/useReveal'
import DomeGallery from '../components/DomeGallery'
import styles from './Travels.module.css'
    ...
    <main className={styles.main}>
      ...
      <div className={styles.listSection}>
        {PLACES.map((p, i) => {
          const ref = useReveal()
          return (
            <div key={p.name} ref={ref} className={`reveal ${styles.listRow}`}>
          ...
          return (
            <div key={p.name} ref={ref} className={`reveal ${styles.listRow}`}>
              ...
              <span className={styles.listFlag}>{p.flag}</span>
              <div>
                <div className={styles.listName}>{p.name} {p.home && <span className={styles.homeTag}>Home</span>}</div>
                <div className={styles.listDetail}>{p.detail}</div>
              </div>
            </div>
          )
